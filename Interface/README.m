...
user to test out the inputs of the simulated fidgeting device after 'turning it on' and the correspondent alerts that this'll generate as a Matlab App. 
An exemplary processed video for the eye-tracking algorithm is also displayed after pressing the "Video" button. 
